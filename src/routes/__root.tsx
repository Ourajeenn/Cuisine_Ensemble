...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-medium text-foreground">La page n'a pas chargé</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Une erreur est survenue. Essayez de recharger ou revenez à l'accueil.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CuisineEnsemble — Repas partagés dans votre quartier" },
      {
        name: "description",
        content:
          "Organisez et rejoignez des repas partagés près de chez vous. Rompez l'isolement, découvrez de nouvelles cuisines et partagez les coûts.",
      },
      { property: "og:title", content: "CuisineEnsemble — Repas partagés dans votre quartier" },
      {
        property: "og:description",
        content:
          "Rejoignez ou proposez un repas fait maison. Convivialité, découverte, économies partagées.",
      },
